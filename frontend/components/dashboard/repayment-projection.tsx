...
export function RepaymentProjection({
  ...
  // en attendant que le client devine un chiffre. L'apport externe est lui aussi suggéré
  // automatiquement (cf. suggestedExternal, plus bas) pour rester dans la durée
  // contractuelle ; les deux valeurs restent modifiables.
  ...
  return (
    <div className="rounded-lg border border-dashed bg-muted/30 px-4 py-3.5">
      ...
      <p className="mt-1 text-xs text-muted-foreground">
        Remboursement combiné, calculé automatiquement : rendement moyen réel des actifs
        générateurs de rendement + apport externe suggéré pour rester dans la durée
        contractuelle (les deux modifiables). Estimation non garantie, à titre indicatif
        uniquement.
      </p>
        ...
        <div className="grid gap-1.5">
          ...
          <p className="text-[11px] text-muted-foreground">
            {estimatedYieldPct !== null
              ? "Performance réelle sur 12 mois, modifiable."
              : "Calcul en cours…"}
          </p>
        </div>
        <div className="grid gap-1.5">
