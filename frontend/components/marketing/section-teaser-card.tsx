...
// complet d'une section qui vit désormais sur sa propre route (cf. app/page.tsx). Garde
// l'accueil lisible (aperçu + lien) sans dupliquer le contenu détaillé de chaque page.
